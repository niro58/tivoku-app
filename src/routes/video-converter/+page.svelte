<script module>
	const faqs = [
		...
		},
		{
			...
			answer:
				'Yes! All processing happens in your browser—no data is ever uploaded to our servers.',
			key: 'data-safety'
		}
	];
	const features = [
		...
		'@graph': [
			{
				...
				mainEntity: [
					...
					},
					{
						...
						acceptedAnswer: {
							'@type': 'Answer',
							text: 'Yes! All processing happens in your browser—no data is ever uploaded to our servers.'
						}
					}
				]
			}
